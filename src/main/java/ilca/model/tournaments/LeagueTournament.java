...
public final class LeagueTournament extends GroupTournament {
	...
	public LeagueTournament(List<Team> teams, int numberOfRounds) {
		super(teams, numberOfRounds);
	}

	@Override
	public TournamentState startTournamentInstance() {
		return new LeagueTournamentState(this);
	}
}
